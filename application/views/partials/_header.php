...
<link rel="stylesheet" href="<?= base_url(); ?>assets/css/sellolla-compact.css"/>
<link rel="stylesheet" href="<?= base_url(); ?>assets/css/sellolla-premium.css"/>
<link rel="stylesheet" href="<?= base_url(); ?>assets/css/sellolla-patch.css"/>
...
<header id="header">
  ...
  <!--  <div class="main-menu"> -->
    <div class="main-menu" style="position:sticky;top:0;z-index:998;background:#fff;">
        ...
        <div class="modal-dialog modal-dialog-centered login-modal location-modal" role="document">
            <div class="modal-content">
                <div class="auth-box">
                  ...
                  <!--  <p class="location-modal-description"><Select Location></p>  -->
                    <div class="form-group m-b-20">
                <?php /*    <div class="input-group input-group-location">
                    ...
                    <div class="input-group input-group-location" style="display:flex;align-items:center;border:1.5px solid #E5E7EB;border-radius:8px;padding:0 12px;background:#F9FAFB;">
                        <i class="icon-map-marker" style="color:#9CA3AF;font-size:14px;flex-shrink:0;margin-right:8px;"></i>
                            <input type="text" id="input_location" class="form-control form-input" value="<?= $this->default_location_input; ?>" placeholder="Enter city, state or PIN code" autocomplete="off" style="border:none;background:transparent;box-shadow:none;padding:10px 0;font-size:14px;">
